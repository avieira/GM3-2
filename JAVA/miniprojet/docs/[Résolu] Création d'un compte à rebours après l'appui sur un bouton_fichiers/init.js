...
function initTinyMCE(options) {
    ...
    domready(function () {
        ...
        for (var i in textareas) {
            ...
            tinyMCE.settings.setup = function (editor) {
                ...
                editor.onClick.add(function(ed, evt) {
                    ed.focus();
                    currentFocus = ed;
                    textareaContent = $(ed.getContainer().parentNode.getElementsByTagName('textarea'));
                    wysiwygContent = $(ed.getContainer().parentNode.getElementsByClassName('.wysiwygContent'));
                });
        ...
        $('.viewHtml').live('click',function(){
            divContent = $(this).closest('.wysiwygContent');
...
function addWysiwyg(id, hasError)
{
    ...
    if(tinyMCE.activeEditor != null) {
        tinyMCE.activeEditor.setContent(document.getElementById(id).getAttribute('value'));
